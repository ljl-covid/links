...
* the picture for mortality rates is not yet completely clear but rates for the at-risk population appear to be significantly higher than even some of the worst flus
* the mortality profile is very different from even terrible flus like the [Spanish](https://en.wikipedia.org/wiki/Spanish_flu), with the sick and elderly being disproportionately at risk
